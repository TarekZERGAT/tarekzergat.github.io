  ...
  return (
    <F.Container isMobile={isMobile}>
      <F.Text
        data-v2="footer"
        theme={theme}
        aria-label="Designed and built by Tarek ZERGAT"
      >
        {'Designed and built by '}
        <F.Link
          data-v2="creator"
          theme={theme}
          href="https://tarekzergat.github.io/"
          aria-label="Tarek's website"
        ...
        {!isMobile && (
          <>
            ...
            <F.Link
              data-v2="source"
              theme={theme}
              href="https://github.com/TarekZERGAT/tarekzergat.github.io"
