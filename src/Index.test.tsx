...
describe('application tests', () => {
  ...
  it('should render name: Tarek ZERGAT', () => {
    const element = screen.getByTestId('name');

    checkContent(element, /Tarek ZERGAT$/);
  });

  it('should render title: Software Engineer', () => {
    const element = screen.getByTestId('title');

    checkContent(element, /^Senior Software Engineer$/);
  });

  it('should render creator', () => {
    const element = screen.getByTestId('creator');

    checkContent(element, /^Tarek ZERGAT$/, 'https://tarekzergat.github.io/');
  });

  it('should render link to source code', () => {
    const element = screen.getByTestId('source');

    checkContent(element, /^Source$/, 'https://github.com/TarekZERGAT/tarekzergat.github.io');
  });
  ...
  it('should render GitHub button', () => {
    ...
    checkButton(parent, child, /^GitHub$/, 'https://github.com/TarekZERGAT/');
  });
  ...
  it('should render LinkedIn button', () => {
    ...
    checkButton(
      ...
      child,
      /^LinkedIn$/,
      'https://www.linkedin.com/in/tarekzergat/'
    );
  });
  ...
  it('should render Resume button', () => {
    ...
    checkButton(
      ...
      child,
      /^Resume$/,
      'https://drive.google.com/drive/folders/1iZPr8jleyKytRPJLr8F5EZuCuZUMu-4x?usp=sharing'
    );
  });
  ...
  it('should render Email button', () => {
    ...
    checkButton(parent, child, /^Email$/, 'mailto:t.zergat@gmail.com');
  });
  ...
  it('should render full footer on desktop', () => {
    ...
    expect(footer).toHaveTextContent(
      /^Designed and built by Tarek ZERGAT \| Source$/
    );
  });
});
...
describe('app context tests', () => {
  it('should render partial footer on mobile', () => {
    ...
    expect(footer).toHaveTextContent(/^Designed and built by Tarek ZERGAT$/);
